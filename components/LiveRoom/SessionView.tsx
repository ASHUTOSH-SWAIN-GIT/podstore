      ...
      <header className="bg-white border-b border-gray-200 px-8 py-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-6">
            <h1 className="text-2xl font-light text-black tracking-wide">Live Session</h1>
      ...
      <div className="flex-1 flex">
        ...
        <div className="flex-1 bg-black p-8">
          <div className="h-full flex items-center justify-center">
            ...
            <div className="relative">
              ...
              >
                <span className="text-gray-400 font-light tracking-wide">Your Video Feed</span>
              </div>
          ...
          <div className="mt-8">
            <h3 className="text-xl font-light text-white mb-6 tracking-wide">Participants</h3>
            <div
              id="remote-videos"
              ref={remoteVideosRef}
            ...
            {remoteVideosRef.current?.childElementCount === 0 && (
              <div className="text-center py-12">
                <p className="text-gray-400 font-light text-lg">No other participants</p>
                <p className="text-gray-500 mt-2 font-light">Share the session link to invite others</p>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="w-80 bg-white border-l border-gray-200 p-8">
          <div className="space-y-8">
            <div>
              <h3 className="text-lg font-light text-black mb-6 tracking-wide uppercase">Session Details</h3>
              <div className="space-y-4">
                <div className="pb-4 border-b border-gray-100">
                  <span className="block text-xs text-gray-500 uppercase tracking-wider mb-1">Session ID</span>
                  <span className="text-black font-mono text-sm">{sessionId}</span>
                </div>
                <div className="pb-4 border-b border-gray-100">
                  <span className="block text-xs text-gray-500 uppercase tracking-wider mb-1">User ID</span>
            ...
            <div>
              <h3 className="text-lg font-light text-black mb-6 tracking-wide uppercase">Invite Others</h3>
              <div className="space-y-4">
                <div>
